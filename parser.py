...
def parse_args():
    ...
    parser.add_argument('--epochs', type=int, default=15000, help='upper epoch limit')
    ...
    parser.add_argument('--in_dims', type=str, default='[128, 1000, 1000, 128]', help='the dims for item embedding')
